...
write_all2all()
{
    ...
    local indent="       "
    echo -e "$indent   !!!!!!!!!!!!!!!!!!!!!!!!"
    echo -e "$indent   ! $ty1 CO_MINVAL_ALL2ALL"
    echo -e "$indent   !!!!!!!!!!!!!!!!!!!!!!!!"
    echo ""
     for d in `seq 0 7`; do
        echo -e  "$indent  subroutine CO_MINVAL_ALL2ALL_"$ty1"_$d(source, result)"
        ...
        echo -e "$indent    sync all"
        echo -e "$indent  end subroutine CO_MINVAL_ALL2ALL_"$ty1"_$d"
        echo ""
    done
}
...
write_2tree_syncall()
{
    ...
    local indent="       "
    echo -e "$indent   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
    echo -e "$indent   ! $ty1 CO_MINVAL_2TREE_SYNCALL"
    echo -e "$indent   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
    echo ""
     for d in `seq 0 7`; do
        echo -e  "$indent  subroutine CO_MINVAL_2TREE_SYNCALL_"$ty1"_$d(source, result)"
        echo -e -n "$indent    $ty2 :: source"
        if [ $d -gt 0 ]; then
            echo -n "(:"
        fi
        ...
        echo -e "$indent  end subroutine CO_MINVAL_2TREE_SYNCALL_"$ty1"_$d"
        echo ""
    done
}
...
write_2tree_syncimages()
{
    ...
    local indent="       "
    echo -e "$indent   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
    echo -e "$indent   ! $ty1 CO_MINVAL_2TREE_SYNCIMAGES"
    echo -e "$indent   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
    echo ""
     for d in `seq 0 7`; do
        echo -e  "$indent  subroutine CO_MINVAL_2TREE_SYNCIMAGES_"$ty1"_$d(source, result)"
        echo -e -n "$indent    $ty2 :: source"
        if [ $d -gt 0 ]; then
            echo -n "(:"
        fi
        ...
        echo -e "$indent  end subroutine CO_MINVAL_2TREE_SYNCIMAGES_"$ty1"_$d"
        echo ""
    done
}
...
write_2tree_events()
{
    ...
    local indent="       "
    echo -e "$indent   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
    echo -e "$indent   ! $ty1 CO_MINVAL_2TREE_EVENTS"
    echo -e "$indent   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
    echo ""
     for d in `seq 0 7`; do
        echo -e  "$indent  subroutine CO_MINVAL_2TREE_EVENTS_"$ty1"_$d(source, result)"
        ...
        echo -e "$indent  end subroutine CO_MINVAL_2TREE_EVENTS_"$ty1"_$d"
        echo ""
    done
}
...
if [ "$alg" == "all2all" -o "$alg" == "all" ]; then
    echo "" > co_minval_all2all.caf
    for p in 1 2 4 8; do
        ty1="INT$p"
        ty2="integer (kind=$p)"
        write_all2all $ty1 $ty2 >> co_minval_all2all.caf
    done
...
if [ "$alg" == "2tree_syncall" -o "$alg" == "all" ]; then
    echo "" > co_minval_2tree_syncall.caf
    for p in 1 2 4 8; do
        ty1="INT$p"
        ty2="integer (kind=$p)"
        write_2tree_syncall $ty1 $ty2 >> co_minval_2tree_syncall.caf
    done
...
if [ "$alg" == "2tree_syncimages" -o "$alg" == "all" ]; then
    echo "" > co_minval_2tree_syncimages.caf
    for p in 1 2 4 8; do
        ty1="INT$p"
        ty2="integer (kind=$p)"
        write_2tree_syncimages $ty1 $ty2 >> co_minval_2tree_syncimages.caf
    done
...
if [ "$alg" == "2tree_events" -o "$alg" == "all" ]; then
    echo "" > co_minval_2tree_events.caf
    for p in 1 2 4 8; do
        ty1="INT$p"
        ty2="integer (kind=$p)"
        write_2tree_events $ty1 $ty2 >> co_minval_2tree_events.caf
    done
