...
# define OPEN_MP_LIST_CNT               21 /* by jhs, 02/7/20 */
...
# define SYNC_IMAGES_LIB_ENTRY		"_SYNC_IMAGES"
# define SYNC_IMAGES_NAME_LEN		strlen(SYNC_IMAGES_LIB_ENTRY)

# define SYNC_MEMORY_LIB_ENTRY		"_SYNC_MEMORY"
# define SYNC_MEMORY_NAME_LEN		strlen(SYNC_MEMORY_LIB_ENTRY)

# define SYNC_IMAGES_ALL_LIB_ENTRY	"_SYNC_IMAGES_ALL"
# define SYNC_IMAGES_ALL_NAME_LEN	strlen(SYNC_IMAGES_ALL_LIB_ENTRY)

# define SYNC_TEAM_LIB_ENTRY		"_SYNC_TEAM"
# define SYNC_TEAM_NAME_LEN			strlen(SYNC_TEAM_LIB_ENTRY)

# define COARRAY_LOCK_LIB_ENTRY		"_COARRAY_LOCK"
# define COARRAY_LOCK_NAME_LEN		strlen(COARRAY_LOCK_LIB_ENTRY)

# define COARRAY_UNLOCK_LIB_ENTRY	"_COARRAY_UNLOCK"
# define COARRAY_UNLOCK_NAME_LEN	strlen(COARRAY_UNLOCK_LIB_ENTRY)

# define CRITICAL_LIB_ENTRY			"_CRITICAL"
# define CRITICAL_NAME_LEN			strlen(CRITICAL_LIB_ENTRY)

# define END_CRITICAL_LIB_ENTRY		"_END_CRITICAL"
# define END_CRITICAL_NAME_LEN		strlen(END_CRITICAL_LIB_ENTRY)

# define EVENT_POST_LIB_ENTRY		"_EVENT_POST"
# define EVENT_POST_NAME_LEN		strlen(EVENT_POST_LIB_ENTRY)

# define EVENT_QUERY_LIB_ENTRY		"_EVENT_QUERY"
# define EVENT_QUERY_NAME_LEN		strlen(EVENT_QUERY_LIB_ENTRY)

# define EVENT_WAIT_LIB_ENTRY		"_EVENT_WAIT"
# define EVENT_WAIT_NAME_LEN		strlen(EVENT_WAIT_LIB_ENTRY)

# define ERROR_STOP_LIB_ENTRY		"_CAF_ERROR_STOP"
# define ERROR_STOP_NAME_LEN		strlen(ERROR_STOP_LIB_ENTRY)

# define FORM_TEAM_LIB_ENTRY		"_FORM_TEAM"
# define FORM_TEAM_NAME_LEN			strlen(FORM_TEAM_LIB_ENTRY)

# define CHANGE_TEAM_LIB_ENTRY		"_CHANGE_TEAM"
# define CHANGE_TEAM_NAME_LEN		strlen(CHANGE_TEAM_LIB_ENTRY)

# define END_TEAM_LIB_ENTRY			"_END_TEAM"
# define END_TEAM_NAME_LEN			strlen(END_TEAM_LIB_ENTRY)
