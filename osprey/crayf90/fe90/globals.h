...
enum    intrinsic_values       {Unknown_Intrinsic,
				...
				Co_maxminloc_Intrinsic,
				Co_predef_reduce_Intrinsic,
				Co_reduce_Intrinsic,
...
/* ADD NEW OPERATORS AT THE END OF THE LIST!!!!!!!!!!!!                       */
                ...
                Kernels_Loop_Open_Acc_Opr,
                Endkernels_Loop_Open_Acc_Opr,
                Parallel_Open_Acc_Opr,
                Endparallel_Open_Acc_Opr,
                Parallel_Loop_Open_Acc_Opr,
                Endparallel_Loop_Open_Acc_Opr,
                Loop_Open_Acc_Opr,
