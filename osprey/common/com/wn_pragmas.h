...
/* CRAY pragmas */
  ...
  WN_PRAGMA_ACC_ROUTINE,
  WN_PRAGMA_ACC_ENTER_DATA,
  WN_PRAGMA_ACC_EXIT_DATA,
  WN_PRAGMA_ACC_ATOMIC_BEGIN,
  /*OpenACC clause*/   
  ...
  WN_PRAGMA_ACC_CLAUSE_CONST,  
  WN_PRAGMA_ACC_CLAUSE_DEVICE_TYPE,  
  WN_PRAGMA_ACC_CLAUSE_DEFAULT, 
  WN_PRAGMA_ACC_CLAUSE_WAIT,
  WN_PRAGMA_ACC_CLAUSE_SELF,
  WN_PRAGMA_ACC_CLAUSE_NOHOST,
  WN_PRAGMA_ACC_CLAUSE_LINK,
  WN_PRAGMA_ACC_CLAUSE_WRITE,
  WN_PRAGMA_ACC_CLAUSE_READ,
  WN_PRAGMA_ACC_CLAUSE_UPDATE,
  WN_PRAGMA_ACC_CLAUSE_CAPTURE,
  WN_PRAGMA_ACC_CLAUSE_BIND, 
  WN_PRAGMA_ACC_CLAUSE_CACHE,  
  WN_PRAGMA_ACC_CLAUSE_DELETE,  
  WN_PRAGMA_ACC_CLAUSE_DOPE, /*This is a pragma for dynamic array in fortran, 
