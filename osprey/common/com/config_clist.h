...
typedef struct clist_flags {
   ...
   const char *gpu_filename;    /* gpu cuda source code file generated by openacc  */
   const char *gpuh_filename;    /* gpu cuda source code file generated by openacc  */
   const char *cl_filename;    /* gpu opencl source code file generated by openacc  */
   const char *clh_filename;    /* gpu opencl source code file generated by openacc  */
...
#define CLIST_cudah_filename    Current_CLIST->gpuh_filename
#define CLIST_cl_filename     	Current_CLIST->cl_filename
#define CLIST_clh_filename     	Current_CLIST->clh_filename
