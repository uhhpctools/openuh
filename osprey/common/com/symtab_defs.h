...
enum ST_ACC_FLAGS
{
    ...
    ST_IS_ACC_GLOBAL_DATA = 0x00000020,
    ST_IS_ACC_PRIVATE_DATA = 0x00000040
    // new flags must go into flags_ext field.
}; // ST_FLAGS
#endif
...
#define PU_ACC_OPENCL			0x0400000000000000LL //if this bit is 1, the pu is OpenCL kernel function, or it is CUDA kernel function													 
