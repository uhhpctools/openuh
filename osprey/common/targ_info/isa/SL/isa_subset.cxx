//
// Copyright (c) 2011 by SimpLight Nanoelectronics.
// All rights reserved.
//
/********************************************************************\
|*                                                                  *|   
...
main()
{
  ISA_SUBSET mips4,sl1,sl2,sl5,floatext;
  ...
  floatext = ISA_Subset_Create(mips4,"FLOAT");
  Instruction_Group
    (floatext,          
     TOP_abs_s,
     TOP_abs_d,
  ...
  sl1= ISA_Subset_Create(mips4,"SL1");
  ...
  sl2 = ISA_Subset_Create(mips4,"SL2");
  Instruction_Group
    (sl2,
     TOP_c2_mvgr_r2g_h_u,
     TOP_c2_mvgr_r2g_h,
