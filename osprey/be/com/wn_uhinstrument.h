...
#ifndef wn_uhinstrument_INCLUDED
#define wn_uhinstrument_INCLUDED
...
extern void WN_UH_Instrument( WN *wn, PROFILE_PHASE phase );

extern void WN_UH_Annotate(   WN *wn, PROFILE_PHASE phase,
			   MEM_POOL *MEM_pu_pool );

extern void Set_UH_Instrumentation_File_Name( char *fname );

extern void Set_UH_Selective_Instrumentation_File_Name(char *fname);
