				     ...
				     BOOL trace)
{
  ...
  for (INT i = 0; i < num_dims; i++) {
    PROJECTED_NODE* pn_callsite = _callsite_region->Get_projected_node(i);
    LINEX* lx_callsite = pn_callsite->Get_lower_linex();
    PROJECTED_NODE* pn_reshaped = callee_reshaped->Get_projected_node(i);
